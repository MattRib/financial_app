...
describe('TransactionsService', () => {
  ...
  describe('update', () => {
    it('should update a transaction', async () => {
      ...
      const result = await service.update(mockUserId, 'trans-123', {
        amount: 200,
      });
  ...
  describe('getByCategory', () => {
    ...
    it('should handle uncategorized transactions', async () => {
      const transactions = [
        { amount: 100, category_id: null, categories: null },
      ];
      ...
      const transactions = [
        {
          amount: 50,
          category_id: 'cat-1',
          categories: { name: 'A', color: '#000' },
        },
        {
          amount: 50,
          category_id: 'cat-2',
          categories: { name: 'B', color: '#fff' },
        },
      ];
